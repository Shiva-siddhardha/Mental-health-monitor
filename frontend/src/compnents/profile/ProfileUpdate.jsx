...
//             try {
//                 const response = await fetch(`http://localhost:5000/${username}/getuserdetails`);
...
//             const response = await axios.patch(`http://localhost:5000/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});
